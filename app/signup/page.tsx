    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-6">
        <div className="relative z-10 w-full max-w-sm text-center">
          ...
          <Link href="/login" className="mt-8 inline-block text-[#DEB04A] text-sm hover:text-[#E8C060] transition-colors">
            Back to sign in
          </Link>
        </div>
      </main>
    ...
    <main className="min-h-screen flex items-center justify-center px-6">
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <p className="text-white/35 text-sm mt-2">Master your first track free</p>
        </div>

        <form onSubmit={handleSignup} className="bg-[#0F0E1C] border border-white/8 rounded-2xl p-8 space-y-5">
          <div>
        ...
        <p className="text-center text-white/30 text-sm mt-6">
          ...
          <Link href="/login" className="text-[#DEB04A] hover:text-[#E8C060] transition-colors">
            Sign in
          </Link>
        </p>
      </div>
